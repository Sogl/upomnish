Всего не упомнишь, поэтому я создал этот репозиторий со списком всевозможных команд (зачастую, консольных) и операций, которые совершал в разное время своей работы.
